...
class Config:
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/TG_API_ID_HASH_BOT")
    ...
    # please reopen
    # https://github.com/xoMUNNAox/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/TG_API_ID_HASH_BOT"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @SEDxD")
